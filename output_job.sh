...
PCBNAME=ESP32-BOBOARD-5V
PCBNAMEOUT=${PCBNAME}-RBL
KICADBOMSCRIPT=${HOME}/.kicad/bom
PDFOUTPUT=schematics/${PCBNAME}.pdf
...
echo "Creating PDF..."
# Help eeplot locate KiCad 5 symbol libraries
...
eeplot -o ${PDFOUTPUT} \
    ...
    /usr/share/kicad/library/Logic_LevelTranslator.lib \
